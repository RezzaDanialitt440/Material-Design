...
! function(t) {
    ...
    function S(t) {
        ...
        function s(t) {
            ...
            if (i = Object.keys(n).length)
                for (s = 0; i > s; s++) H || (H = p(document.body, "transform") ? "transform" : "-webkit-transform"), v.animatables[s].target.style[H] = n[s].join(" ");
    ...
    return S.version = "2.2.0", S.speed = 1, S.running = N, S.remove = function(t) {
        ...
        for (var e = N.length; e--;)
            for (var i = N[e], n = i.animations, o = n.length; o--;) s(t, n[o].animatable.target) && (n.splice(o, 1), n.length || i.pause())
        ...
        e = function(e) {
            ...
            return _inherits(i, e), _createClass(i, [{
                ...
                value: function y(t, e) {
                    ...
                    var n = [];
                    for (var s in t)
                        if (t.hasOwnProperty(s) && -1 !== s.toLowerCase().indexOf(e)) {
    ...
    var t = {
        ...
        e = function(e) {
            ...
            return _inherits(i, e), _createClass(i, [{
                ...
                key: "_setupInput",
                value: function v() {
                    this.$input = this.$el.find("input"), this.$input.length || (this.$input = $("<input></input>"), this.$el.append(this.$input)),
        ...
        e = function(e) {
            ...
            return _inherits(i, e), _createClass(i, [{
                ...
                value: function v() {
                    ...
                    $('<button class="btn-flat timepicker-close waves-effect" type="button" tabindex="' + (this.options.twelveHour ? "3" : "1") + '">' + this.options.i18n.cancel + "</button>").appendTo(e).on("click", this.close.bind(this)),
                        $('<button class="btn-flat timepicker-close waves-effect" type="button" tabindex="' + (this.options.twelveHour ? "3" : "1") + '">' + this.options.i18n.done + "</button>").appendTo(e).on("click", this.done.bind(this)), e.appendTo(this.footer)
                }
            }, {
                key: "_clockSetup",
                value: function f() {
        ...
        e = function(e) {
            ...
            return _inherits(i, e), _createClass(i, [{
                ...
                value: function u() {
                    ...
                    if (!t)
                        for (var e = this.$origin.parents(), i = 0; i < e.length && !(t = "fixed" == $(e[i]).css("position")); i++);
...
var debounce = function(t, e) {
    ...
    chartExists = function(t) {
        ...
        for (var i in Chart.instances)
            if (chart = Chart.instances[i], t.is(chart.canvas)) {
                e = !0;
                break
            }
        return e ? chart : !1
...
var percentageFooterCallback = function(t, e) {
    ...
    doughnutLegendCallback = function(t) {
        var e = $('<div class="chart-legend"></div>'),
            i = $("<ul></ul>"),
            n = t.data.labels;
        if (t.data.datasets.length)
            for (var s = 0; s < t.data.datasets[0].data.length; s++) {
